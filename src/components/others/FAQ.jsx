					...
					<div className="ml-auto mr-auto col-lg-9">
						<div className="checkout-wrapper">
							<div className="inner-descripe" data-aos="fade-up" data-aos-delay="200">
								<h4 className="title">Below are frequently asked questions, you may find the answer for yourself
								</h4>
							...
							<div id="faq" className="panel-group">
								<div className="panel panel-default single-my-account" data-aos="fade-up" data-aos-delay="200">
									<div className="panel-heading my-account-title">
										<h3 className="panel-title"><span>1 .</span> <a data-bs-toggle="collapse" href="#my-account-1" className="collapsed" aria-expanded="true">Mauris congue
								...
								<div className="panel panel-default single-my-account" data-aos="fade-up" data-aos-delay="200">
									<div className="panel-heading my-account-title">
										<h3 className="panel-title"><span>2 .</span> <a data-bs-toggle="collapse" href="#my-account-2" aria-expanded="false" className="collapsed">Donec mattis
											finibus elit ut tristique?</a></h3>
									</div>
									<div id="my-account-2" className="panel-collapse collapse" data-bs-parent="#faq">
										<div className="panel-body">Donec mattis finibus elit ut tristique. Nullam tempus nunc
								...
								<div className="panel panel-default single-my-account" data-aos="fade-up" data-aos-delay="200">
									<div className="panel-heading my-account-title">
										<h3 className="panel-title"><span>3 .</span> <a data-bs-toggle="collapse" href="#my-account-3">Aenean elit orci, efficitur quis
											nisl?</a></h3>
									</div>
								...
								<div className="panel panel-default single-my-account" data-aos="fade-up" data-aos-delay="200">
									<div className="panel-heading my-account-title">
										<h3 className="panel-title"><span>4 .</span> <a data-bs-toggle="collapse" href="#my-account-4">Pellentesque habitant morbi
											tristique?</a></h3>
									</div>
								...
								<div className="panel panel-default single-my-account m-0" data-aos="fade-up" data-aos-delay="200">
									<div className="panel-heading my-account-title">
										<h3 className="panel-title"><span>5 .</span> <a data-bs-toggle="collapse" href="#my-account-5">Nam pellentesque aliquam metus?</a>
										</h3>
									</div>

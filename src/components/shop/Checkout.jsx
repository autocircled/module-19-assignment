...
const Checkout = () => {
	...
	useEffect(() => {
		const checkbox2 = document.querySelector('.checkout-toggle2')
		checkbox2.addEventListener('click', function (e) {
			const openToggle2 = document.querySelector('.open-toggle2')
			e.target.checked ? openToggle2.style.display = 'block' : openToggle2.style.display = 'none';
		})
		const checkbox = document.querySelector('.checkout-toggle')
		checkbox.addEventListener('click', function (e) {
			const openToggle = document.querySelector('.open-toggle')
			e.target.checked ? openToggle.style.display = 'block' : openToggle.style.display = 'none';
		})
					...
					<div className="col-lg-7">
						<div className="billing-info-wrap">
							...
							<div className="checkout-account mb-30px">
								<input className="checkout-toggle2 w-auto h-auto" type="checkbox" />
							...
							<div className="your-order-wrap gray-bg-4">
								<div className="your-order-product-info">
									...
									<div className="your-order-middle">
										<ul>
											<li><span className="order-middle-left">Product Name X 1</span> <span
												className="order-price">$100 </span></li>
											<li><span className="order-middle-left">Product Name X 1</span> <span
												className="order-price">$100 </span></li>
										</ul>
									</div>
